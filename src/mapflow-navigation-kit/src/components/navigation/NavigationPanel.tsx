...
interface NavigationPanelProps {
  ...
  onToggleSavedDestination?: () => void;
  isSavedDestination?: boolean;
  topOffset?: number;
  bottomOffset?: number;
}

export default memo(function NavigationPanel({
  onStartNavigation,
  onStopNavigation,
  onToggleSavedDestination,
  ...
  if (route && !isNavigating) {
    ...
    return (
      <View style={[styles.previewContainer, { marginBottom: insets.bottom + 14 + bottomOffset }]}>
        <View style={styles.previewHeader}>
          ...
          <View style={styles.previewActions}>
            {onToggleSavedDestination ? (
              <TouchableOpacity onPress={onToggleSavedDestination} style={styles.closeBtn} activeOpacity={0.85}>
                <MaterialIcons
                  name={isSavedDestination ? 'bookmark' : 'bookmark-border'}
                  size={20}
                  color={isSavedDestination ? COLORS.primary : COLORS.textSecondary}
                />
              </TouchableOpacity>
            ) : null}
  ...
  if (isNavigating && route) {
    ...
    return (
      <>
        <View style={[styles.turnBanner, { top: insets.top + 24 + topOffset }]}>
        ...
        <View style={[styles.navContainer, { marginBottom: insets.bottom + 14 + bottomOffset }]}>

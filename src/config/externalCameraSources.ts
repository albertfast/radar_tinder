...
export const EXTERNAL_CAMERA_SOURCE_RULES: ExternalCameraSourceRule[] = [
  ...
  },
  {
    ...
    notes: 'Official SFMTA red-light enforcement feed grouped by enforced direction.',
    matchingHints: ['san francisco red light', 'sfmta', 'socrata'],
  },
  {
  ...
  },
  {
    ...
    label: 'Los Angeles Speed Safety System (Proposed)',
    provider: 'government_open_data',
    region: 'Los Angeles',
    countryCodes: ['US'],
    status: 'planned',
    ingestMode: 'api',
    alertPolicy: 'ignore',
    endpointUrl: 'https://ladot.lacity.gov/speed-safety-system',
    updateCadence: 'program rollout dependent',
    cameraTypes: ['speed_camera'],
    notes:
      'Official LADOT planned speed safety system segments from February 2026. Keep out of driver alerts until the city confirms active enforcement.',
    matchingHints: ['ladot', 'speed safety system', 'attachment a', 'los angeles'],
  },
  {
  ...
  },
  {
    ...
    updateCadence: 'daily',
    cameraTypes: ['speed_camera'],
    notes: 'Official City of Chicago speed-camera export deduped by camera_id.',
    matchingHints: ['chicago', 'speed camera violations', 'socrata', 'camera_id'],
  },
  {
    ...
    updateCadence: 'daily',
    cameraTypes: ['red_light'],
    notes: 'Official City of Chicago red-light export deduped by camera_id.',
    matchingHints: ['chicago', 'red light camera', 'violations', 'camera_id'],
  },
  {

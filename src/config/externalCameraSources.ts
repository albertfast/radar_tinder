...
export const EXTERNAL_CAMERA_SOURCE_RULES: ExternalCameraSourceRule[] = [
  ...
  },
  {
    ...
    updateCadence: 'daily',
    cameraTypes: ['speed_camera'],
    notes: 'Discovery/validation dataset only. Not yet a verified authoritative camera feed.',
    matchingHints: ['chicago', 'speed camera violations', 'socrata'],
  },
  {
    ...
    notes: 'Discovery/validation dataset only. Not yet safe for direct production alerts.',
    matchingHints: ['chicago', 'red light camera', 'violations'],
  },
  {
